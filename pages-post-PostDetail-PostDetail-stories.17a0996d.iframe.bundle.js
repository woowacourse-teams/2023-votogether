"use strict";(self.webpackChunkvotogether=self.webpackChunkvotogether||[]).push([[8927],{"./src/pages/post/PostDetail/PostDetail.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{WriterCase:()=>WriterCase,__namedExportsOrder:()=>__namedExportsOrder,default:()=>PostDetail_stories});var react=__webpack_require__("./node_modules/react/index.js"),dist=__webpack_require__("./node_modules/react-router/dist/index.js"),auth=__webpack_require__("./src/hooks/context/auth.tsx"),useQuery=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/useQuery.mjs"),comment=__webpack_require__("./src/api/comment.ts"),queryKey=__webpack_require__("./src/constants/queryKey.ts");var QueryClientProvider=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/QueryClientProvider.mjs"),useMutation=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/useMutation.mjs"),post=__webpack_require__("./src/api/post.ts");var usePostDetail=__webpack_require__("./src/hooks/query/post/usePostDetail.ts"),useToast=__webpack_require__("./src/hooks/useToast.ts"),report=__webpack_require__("./src/api/report.ts"),CommentList=__webpack_require__("./src/components/comment/CommentList/index.tsx"),Layout=__webpack_require__("./src/components/common/Layout/index.tsx"),NarrowTemplateHeader=__webpack_require__("./src/components/common/NarrowTemplateHeader/index.tsx"),Post=__webpack_require__("./src/components/common/Post/index.tsx"),Toast=__webpack_require__("./src/components/common/Toast/index.tsx"),time=__webpack_require__("./src/utils/time.ts"),BottomButtonPart=__webpack_require__("./src/pages/post/PostDetail/BottomButtonPart/index.tsx"),InnerHeaderPart=__webpack_require__("./src/pages/post/PostDetail/InnerHeaderPart/index.tsx"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),theme=__webpack_require__("./src/styles/theme.ts");const HeaderContainer=styled_components_browser_esm.zo.div`
  position: fixed;
  width: 100%;
  top: 0;
...
`,MainContainer=styled_components_browser_esm.zo.div`
  display: flex;
...
`,BottomContainer=styled_components_browser_esm.zo.div`
  margin: 10px;
  margin-bottom: 30px;
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function PostDetailPage(){const navigate=(0,dist.s0)(),params=(0,dist.UO)(),postId=Number(params.postId),{isToastOpen,openToast,toastMessage}=(0,useToast.p)(),{loggedInfo}=(0,react.useContext)(auth.V),memberId=loggedInfo.id,{data:postData,isLoading,isError:isPostError,error:postError}=(0,usePostDetail.S)(!loggedInfo.isLoggedIn,postId),{mutate:deletePost,isSuccess:isDeleteSuccess,isError:isDeleteError,error:deleteError}=((postId,isLogged)=>{const queryClient=(0,QueryClientProvider.NL)(),{mutate,isSuccess,isError,error}=(0,useMutation.D)({mutationFn:()=>(0,post.fR)(postId),onSuccess:()=>{queryClient.invalidateQueries([queryKey.l.USER_INFO,isLogged])},onError:error=>{window.console.log("게시물 삭제에 실패했습니다.",error)}});return{mutate,isSuccess,isError,error}})(postId,loggedInfo.isLoggedIn),{mutate:earlyClosePost}=(postId=>{const queryClient=(0,QueryClientProvider.NL)(),{mutate,isError,error}=(0,useMutation.D)({mutationFn:()=>(0,post.yx)(postId),onSuccess:()=>{queryClient.invalidateQueries([queryKey.l.POST_DETAIL,postId])},onError:error=>{window.console.log("조기마감에 실패했습니다.",error)}});return{mutate,isError,error}})(postId),{data:commentData,isLoading:isCommentLoading}=(postId=>{const{data,error,isLoading}=(0,useQuery.a)([queryKey.l.POSTS,postId,queryKey.l.COMMENTS],(()=>(0,comment.Rw)(postId)),{onSuccess:data=>data,onError:error=>{window.console.log("get comment list error",error)}});return{data,error,isLoading}})(postId);if((0,react.useEffect)((()=>{isDeleteError&&deleteError instanceof Error&&openToast(deleteError.message)}),[isDeleteError,deleteError]),(0,react.useEffect)((()=>{isDeleteSuccess&&navigate("/")}),[isDeleteSuccess,navigate]),!postData)return(0,jsx_runtime.jsxs)(Layout.Z,{isSidebarVisible:!0,children:[(0,jsx_runtime.jsx)(HeaderContainer,{children:(0,jsx_runtime.jsx)(NarrowTemplateHeader.Z,{})}),(0,jsx_runtime.jsxs)(MainContainer,{children:[isLoading&&"loading",isPostError&&postError instanceof Error&&postError.message]})]});if(isLoading)return(0,jsx_runtime.jsx)("div",{children:"로딩중"});const isWriter=postData.writer.id===memberId,isClosed=(0,time.gr)(postData.deadline),movePage={moveWritePostPage:()=>{postData.voteInfo.allPeopleCount&&openToast("투표한 사용자가 있어 글 수정이 불가합니다."),navigate(`/posts/write/${postId}`)},moveVoteStatisticsPage:()=>{navigate(`/posts/result/${postId}`)},movePostListPage:()=>{navigate("/")}},controlPost={setEarlyClosePost:earlyClosePost,deletePost:()=>{postData.voteInfo.allPeopleCount>=20?openToast("20인 이상 투표한 게시물은 삭제할 수 없습니다."):deletePost()},reportPost:async reason=>{const reportData={type:"POST",id:postId,reason};await(0,report.K)(reportData).then((res=>{openToast("게시물을 신고했습니다.")})).catch((e=>{openToast(e instanceof Error?e.message:"게시물 신고가 실패했습니다")}))},reportNickname:async reason=>{const reportData={type:"NICKNAME",id:postData.writer.id,reason};await(0,report.K)(reportData).then((res=>{openToast("작성자 닉네임을 신고했습니다.")})).catch((e=>{openToast(e instanceof Error?e.message:"작성자 닉네임 신고가 실패했습니다.")}))}};return(0,jsx_runtime.jsxs)(Layout.Z,{isSidebarVisible:!0,children:[(0,jsx_runtime.jsx)(HeaderContainer,{children:(0,jsx_runtime.jsx)(NarrowTemplateHeader.Z,{children:(0,jsx_runtime.jsx)(InnerHeaderPart.Z,{isClosed,isWriter,handleEvent:{movePage,controlPost}})})}),(0,jsx_runtime.jsxs)(MainContainer,{children:[(0,jsx_runtime.jsx)(Post.Z,{postInfo:postData,isPreview:!1}),(0,jsx_runtime.jsx)(BottomButtonPart.Z,{isClosed,isWriter,handleEvent:{movePage,controlPost}})]}),!isCommentLoading&&(0,jsx_runtime.jsx)(BottomContainer,{children:(0,jsx_runtime.jsx)(CommentList.Z,{commentList:commentData??[],memberId,isGuest:!loggedInfo.isLoggedIn,postWriterName:postData.writer.nickname})}),isToastOpen&&(0,jsx_runtime.jsx)(Toast.Z,{size:"md",position:"bottom",children:toastMessage})]})}PostDetailPage.displayName="PostDetailPage";const PostDetail_stories={component:PostDetailPage},WriterCase={render:()=>(0,jsx_runtime.jsx)(PostDetailPage,{})};WriterCase.parameters={...WriterCase.parameters,docs:{...WriterCase.parameters?.docs,source:{originalSource:"{\n  render: () => <PostDetailPage />\n}",...WriterCase.parameters?.docs?.source}}};const __namedExportsOrder=["WriterCase"]},"./src/components/comment/CommentList/CommentLoginSection/index.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Z:()=>CommentLoginSectionSection});var path=__webpack_require__("./src/constants/path.ts");const kakao_login_large_namespaceObject=__webpack_require__.p+"static/media/kakao_login_large.0a33a8d0.svg";var dist=__webpack_require__("./node_modules/react-router-dom/dist/index.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),theme=__webpack_require__("./src/styles/theme.ts");const Container=styled_components_browser_esm.zo.section`
  display: flex;
  flex-direction: column;
