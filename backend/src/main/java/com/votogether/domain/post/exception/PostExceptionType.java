...
public enum PostExceptionType implements ExceptionType {
    ...
    POST_NOT_WRITER(501, "게시글 작성자가 아닙니다."),
    POST_CLOSED(502, "게시글이 마감되었습니다."),
    ...
    POST_TITLE_EMPTY(507, "게시글 제목은 비어있거나 공백일 수 없습니다."),
    POST_CONTENT_EMPTY(508, "게시글 내용은 비어있거나 공백일 수 없습니다."),
    POST_TITLE_INVALID_LENGTH(509, "게시글 제목 길이가 유효하지 않습니다."),
    POST_CONTENT_INVALID_LENGTH(510, "게시글 내용 길이가 유효하지 않습니다."),
    POST_IS_HIDDEN(511, "신고에 의해 숨겨진 게시글은 접근할 수 없습니다."),
    ;
