...
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function CommentTextForm({commentId,initialComment,handleCancelClick}){const{handleTextChange,text:content,resetText}=(0,useText.X)(initialComment.content),params=(0,dist.UO)(),postId=Number(params.postId),{mutate:createComment}=useCreateComment(postId),{mutate:editComment}=useEditComment(postId,commentId,{...initialComment,content}),updateComment=-1!==initialComment.id?()=>{editComment(),handleCancelClick&&handleCancelClick()}:()=>{resetText(),createComment({content}),handleCancelClick&&handleCancelClick()};return(0,jsx_runtime.jsxs)(Container,{children:[(0,jsx_runtime.jsx)(TextArea,{value:content,onChange:e=>handleTextChange(e,COMMENT_MAX_LENGTH)}),(0,jsx_runtime.jsxs)(ButtonContainer,{children:[handleCancelClick&&(0,jsx_runtime.jsx)(ButtonWrapper,{children:(0,jsx_runtime.jsx)(SquareButton.Z,{onClick:handleCancelClick,theme:"gray",type:"button",children:"취소"})}),(0,jsx_runtime.jsx)(ButtonWrapper,{children:(0,jsx_runtime.jsx)(SquareButton.Z,{onClick:()=>updateComment(),theme:"blank",type:"button",children:"저장"})})]})]})}CommentTextForm.displayName="CommentTextForm";try{CommentTextForm.displayName="CommentTextForm",CommentTextForm.__docgenInfo={description:"",displayName:"CommentTextForm",props:{commentId:{defaultValue:null,description:"",name:"commentId",required:!0,type:{name:"number"}},initialComment:{defaultValue:null,description:"",name:"initialComment",required:!0,type:{name:"Comment"}},handleCancelClick:{defaultValue:null,description:"",name:"handleCancelClick",required:!1,type:{name:"(() => void)"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/comment/CommentList/CommentTextForm/index.tsx#CommentTextForm"]={docgenInfo:CommentTextForm.__docgenInfo,name:"CommentTextForm",path:"src/components/comment/CommentList/CommentTextForm/index.tsx#CommentTextForm"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/comment/CommentList/constants.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{GD:()=>COMMENT_USER,H4:()=>COMMENT_MENU,PB:()=>COMMENT_USER_MENU,_d:()=>COMMENT_ACTION});const COMMENT_USER={GUEST:"GUEST",NOT_WRITER:"NOT_WRITER",WRITER:"WRITER"},COMMENT_ACTION={DELETE:"delete",USER_REPORT:"userReport",COMMENT_REPORT:"commentReport",EDIT:"edit"},COMMENT_USER_MENU={[COMMENT_USER.GUEST]:COMMENT_USER.NOT_WRITER,[COMMENT_USER.NOT_WRITER]:COMMENT_USER.NOT_WRITER,[COMMENT_USER.WRITER]:COMMENT_USER.WRITER},COMMENT_MENU={[COMMENT_USER.NOT_WRITER]:[{color:"black",content:"유저 신고",action:COMMENT_ACTION.USER_REPORT},{color:"black",content:"댓글 신고",action:COMMENT_ACTION.COMMENT_REPORT}],[COMMENT_USER.WRITER]:[{content:"수정",color:"black",action:COMMENT_ACTION.EDIT},{content:"삭제",color:"red",action:COMMENT_ACTION.DELETE}]}},"./src/components/common/DeleteModal/index.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Z:()=>DeleteModal});var TwoButtonModal=__webpack_require__("./src/components/common/TwoButtonModal/index.tsx"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),theme=__webpack_require__("./src/styles/theme.ts");const Description=styled_components_browser_esm.zo.p`
  color: #67727e;
...
//# sourceMappingURL=4146.1d5c7016.iframe.bundle.js.map