"use strict";(self.webpackChunkvotogether=self.webpackChunkvotogether||[]).push([[4306],{"./src/pages/post/EditPostPage/EditPostPage.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>EditPostPage_stories});var react=__webpack_require__("./node_modules/react/index.js"),ErrorBoundaryWithNarrowHeader=__webpack_require__("./src/pages/ErrorBoundaryWithNarrowHeader.tsx"),Layout=__webpack_require__("./src/components/common/Layout/index.tsx"),NarrowTemplateHeader=__webpack_require__("./src/components/common/NarrowTemplateHeader/index.tsx"),Skeleton=__webpack_require__("./src/components/common/Skeleton/index.tsx"),dist=__webpack_require__("./node_modules/react-router/dist/index.js"),useEditPost=__webpack_require__("./src/hooks/query/post/useEditPost.ts"),usePostDetail=__webpack_require__("./src/hooks/query/post/usePostDetail.ts"),useToast=__webpack_require__("./src/hooks/useToast.ts"),Toast=__webpack_require__("./src/components/common/Toast/index.tsx"),PostForm=__webpack_require__("./src/components/PostForm/index.tsx"),path=__webpack_require__("./src/constants/path.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function EditPost(){const navigate=(0,dist.s0)(),{postId}=(0,dist.UO)(),{data}=(0,usePostDetail.S)(!0,Number(postId)),{mutate,isSuccess,isError,error}=(0,useEditPost.B)(Number(postId)),{isToastOpen,openToast,toastMessage}=(0,useToast.p)();return(0,react.useEffect)((()=>{window.scrollTo({top:0,left:0,behavior:"auto"})}),[]),(0,react.useEffect)((()=>{isSuccess&&navigate(`${path.m.POST}/${postId}`)}),[isSuccess,navigate,postId]),(0,react.useEffect)((()=>{isError&&error instanceof Error&&openToast(error.message)}),[isError,error,openToast]),(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(PostForm.Z,{data,mutate}),isToastOpen&&(0,jsx_runtime.jsx)(Toast.Z,{size:"md",position:"bottom",children:toastMessage})]})}var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),theme=__webpack_require__("./src/styles/theme.ts");const SkeletonWrapper=styled_components_browser_esm.zo.div`
...
//# sourceMappingURL=pages-post-EditPostPage-EditPostPage-stories.2c93743f.iframe.bundle.js.map