...
`,ButtonWrapper=styled_components_browser_esm.zo.div`
  ...
  position: absolute;
  bottom: 30px;
`;var UserProfile=__webpack_require__("./src/components/common/Dashboard/UserProfile/index.tsx");function Dashboard(){const{loggedInfo,clearLoggedInfo}=(0,react.useContext)(auth.V),{userInfo}=loggedInfo;return(0,jsx_runtime.jsxs)(Container,{children:[userInfo?(0,jsx_runtime.jsx)(UserProfile.Z,{userInfo}):(0,jsx_runtime.jsx)(GuestProfile.Z,{}),(0,jsx_runtime.jsx)(CategorySectionWrapper,{children:(0,jsx_runtime.jsx)(ErrorBoundary.Z,{children:(0,jsx_runtime.jsx)(react.Suspense,{fallback:(0,jsx_runtime.jsx)(Skeleton.Z,{isLarge:!0}),children:(0,jsx_runtime.jsx)(CategorySection,{})})})}),userInfo&&(0,jsx_runtime.jsx)(ButtonWrapper,{children:(0,jsx_runtime.jsx)(SquareButton.Z,{theme:"blank",onClick:()=>{(0,cookie.ql)("accessToken"),clearLoggedInfo()},children:"로그아웃"})})]})}Dashboard.displayName="Dashboard"},"./src/components/common/Dashboard/profileStyle.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{U:()=>ProfileContainer});const ProfileContainer=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").zo.div`
  display: flex;
  flex-direction: column;
  justify-content: end;
...
//# sourceMappingURL=5455.f0f12aa7.iframe.bundle.js.map