"use strict";(self.webpackChunkvotogether=self.webpackChunkvotogether||[]).push([[9993],{"./src/pages/MyInfo/MyInfo.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>MyInfo_stories});var react=__webpack_require__("./node_modules/react/index.js"),dist=__webpack_require__("./node_modules/react-router/dist/index.js"),auth=__webpack_require__("./src/hooks/context/auth.tsx"),QueryClientProvider=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/QueryClientProvider.mjs"),useMutation=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/useMutation.mjs"),userInfo=__webpack_require__("./src/api/userInfo.ts"),queryKey=__webpack_require__("./src/constants/queryKey.ts");var useText=__webpack_require__("./src/hooks/useText.ts"),useToggle=__webpack_require__("./src/hooks/useToggle.tsx"),Accordion=__webpack_require__("./src/components/common/Accordion/index.tsx"),GuestProfile=__webpack_require__("./src/components/common/Dashboard/GuestProfile/index.tsx"),UserProfile=__webpack_require__("./src/components/common/Dashboard/UserProfile/index.tsx"),IconButton=__webpack_require__("./src/components/common/IconButton/index.tsx"),Layout=__webpack_require__("./src/components/common/Layout/index.tsx"),Modal=__webpack_require__("./src/components/common/Modal/index.tsx"),NarrowTemplateHeader=__webpack_require__("./src/components/common/NarrowTemplateHeader/index.tsx"),SquareButton=__webpack_require__("./src/components/common/SquareButton/index.tsx"),path=__webpack_require__("./src/constants/path.ts"),user=__webpack_require__("./src/constants/user.ts"),cookie=__webpack_require__("./src/utils/cookie/index.ts"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),theme=__webpack_require__("./src/styles/theme.ts");const Wrapper=styled_components_browser_esm.zo.div`
  display: flex;
...
`,ButtonListWrapper=styled_components_browser_esm.zo.div`
  ...
  margin-top: 20px;
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function MyInfo(){const navigate=(0,dist.s0)(),{mutate:modifyNickname}=(()=>{const queryClient=(0,QueryClientProvider.NL)(),{mutate,isLoading}=(0,useMutation.D)({mutationFn:nickname=>(0,userInfo.K7)(nickname),onMutate:async newNickname=>{await queryClient.cancelQueries({queryKey:[queryKey.l.USER_INFO]});const previousNickname=queryClient.getQueryData([queryKey.l.USER_INFO]);return queryClient.setQueryData([queryKey.l.USER_INFO],newNickname),{previousNickname,newNickname}},onError:(error,__,context)=>{queryClient.setQueryData([queryKey.l.USER_INFO],context?.previousNickname),window.console.error("닉네임 변경에 실패했습니다."),alert("닉네임 변경에 실패했습니다.")},onSettled:()=>{queryClient.invalidateQueries({queryKey:[queryKey.l.USER_INFO]})}});return{mutate,isLoading}})(),{mutate:withdrawalMembership}=(()=>{const queryClient=(0,QueryClientProvider.NL)(),{mutate,isLoading}=(0,useMutation.D)({mutationFn:()=>(0,userInfo.N6)(),onSuccess:()=>{queryClient.invalidateQueries({queryKey:[queryKey.l.USER_INFO]})},onError:()=>{window.console.error("회원 탈퇴에 실패했습니다."),alert("회원 탈퇴에 실패했습니다.")}});return{mutate,isLoading}})(),{isOpen,openComponent,closeComponent}=(0,useToggle.O)(),{loggedInfo,clearLoggedInfo}=(0,react.useContext)(auth.V),{text:newNickname,handleTextChange:handleNicknameChange}=(0,useText.X)(loggedInfo.userInfo?.nickname??"");if(!loggedInfo.userInfo)return(0,jsx_runtime.jsx)(dist.Fg,{to:path.m.LOGIN});return(0,jsx_runtime.jsx)(Layout.Z,{isSidebarVisible:!0,children:(0,jsx_runtime.jsxs)(Wrapper,{children:[(0,jsx_runtime.jsx)(HeaderWrapper,{children:(0,jsx_runtime.jsx)(NarrowTemplateHeader.Z,{children:(0,jsx_runtime.jsx)(IconButton.Z,{category:"back",onClick:()=>{navigate(-1)}})})}),(0,jsx_runtime.jsx)(ProfileSection,{children:loggedInfo.userInfo?(0,jsx_runtime.jsx)(UserProfile.Z,{userInfo:loggedInfo.userInfo}):(0,jsx_runtime.jsx)(GuestProfile.Z,{})}),(0,jsx_runtime.jsxs)(UserControlSection,{children:[(0,jsx_runtime.jsxs)(Accordion.Z,{title:"닉네임 변경",children:[(0,jsx_runtime.jsx)(Input,{value:newNickname,onChange:e=>handleNicknameChange(e,user.O),placeholder:"새로운 닉네임을 입력해주세요"}),(0,jsx_runtime.jsx)(ButtonWrapper,{children:(0,jsx_runtime.jsx)(SquareButton.Z,{"aria-label":"닉네임 변경",theme:"fill",onClick:()=>{modifyNickname(newNickname)},children:"변경"})})]}),(0,jsx_runtime.jsxs)(Accordion.Z,{title:"회원 탈퇴",children:[(0,jsx_runtime.jsx)(ButtonWrapper,{children:(0,jsx_runtime.jsx)(SquareButton.Z,{onClick:openComponent,"aria-label":"회원 탈퇴",theme:"blank",children:"회원 탈퇴"})}),isOpen&&(0,jsx_runtime.jsx)(Modal.Z,{size:"sm",onModalClose:closeComponent,children:(0,jsx_runtime.jsxs)(ModalBody,{children:[(0,jsx_runtime.jsx)(ModalTitle,{children:"정말 탈퇴하시겠어요?"}),(0,jsx_runtime.jsxs)(ModalDescription,{children:["탈퇴 버튼 클릭 시, ",(0,jsx_runtime.jsx)("br",{}),"계정은 삭제되며 복구되지 않아요."]}),(0,jsx_runtime.jsxs)(ButtonListWrapper,{children:[(0,jsx_runtime.jsx)(SquareButton.Z,{onClick:()=>{withdrawalMembership(),(0,cookie.ql)("accessToken"),clearLoggedInfo()},"aria-label":"회원 탈퇴",theme:"fill",children:"탈퇴"}),(0,jsx_runtime.jsx)(SquareButton.Z,{onClick:closeComponent,"aria-label":"회원 탈퇴",theme:"blank",children:"취소"})]})]})})]})]})]})})}MyInfo.displayName="MyInfo";const MyInfo_stories={component:MyInfo},Default={render:()=>(0,jsx_runtime.jsx)(MyInfo,{})};Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  render: () => <MyInfo />\n}",...Default.parameters?.docs?.source}}};const __namedExportsOrder=["Default"]},"./src/components/common/Accordion/index.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Z:()=>Accordion});var react=__webpack_require__("./node_modules/react/index.js"),chevron_down=__webpack_require__("./src/assets/chevron-down.svg"),chevron_up=__webpack_require__("./src/assets/chevron-up.svg"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Wrapper=styled_components_browser_esm.ZP.div`
  width: 100%;
...
//# sourceMappingURL=pages-MyInfo-MyInfo-stories.636e1e57.iframe.bundle.js.map