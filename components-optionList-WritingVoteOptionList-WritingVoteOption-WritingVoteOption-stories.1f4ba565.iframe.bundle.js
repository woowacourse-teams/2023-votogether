"use strict";(self.webpackChunkvotogether=self.webpackChunkvotogether||[]).push([[9043],{"./src/components/optionList/WritingVoteOptionList/WritingVoteOption/WritingVoteOption.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{IsDeletable:()=>IsDeletable,IsNotDeletable:()=>IsNotDeletable,ShowImage:()=>ShowImage,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var ___WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/components/optionList/WritingVoteOptionList/WritingVoteOption/index.tsx"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/react/jsx-runtime.js");const __WEBPACK_DEFAULT_EXPORT__={component:___WEBPACK_IMPORTED_MODULE_0__.Z},IsDeletable={render:()=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(___WEBPACK_IMPORTED_MODULE_0__.Z,{ariaLabel:"",imageUrl:"",handleUpdateOptionChange:()=>{},handleDeleteOptionClick:()=>{},handleRemoveImageClick:()=>{},handleUploadImage:()=>{},optionId:Math.floor(1e5*Math.random()),text:"방학 때 강릉으로  강아지와 기차여행을 하려했지 만 장마가 와서 취소했어요. 여행을 별로 좋",isDeletable:!0})},IsNotDeletable={render:()=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(___WEBPACK_IMPORTED_MODULE_0__.Z,{ariaLabel:"",imageUrl:"",handleUpdateOptionChange:()=>{},handleDeleteOptionClick:()=>{},handleRemoveImageClick:()=>{},handleUploadImage:()=>{},optionId:Math.floor(1e5*Math.random()),text:"방학 때 강릉으로  강아지와 기차여행을 하려했지 만 장마가 와서 취소했어요. 여행을 별로 좋",isDeletable:!1})},ShowImage={render:()=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(___WEBPACK_IMPORTED_MODULE_0__.Z,{ariaLabel:"",handleUpdateOptionChange:()=>{},handleDeleteOptionClick:()=>{},handleRemoveImageClick:()=>{},handleUploadImage:()=>{},optionId:Math.floor(1e5*Math.random()),text:"방학 때 강릉으로  강아지와 기차여행을 하려했지 만 장마가 와서 취소했어요. 여행을 별로 좋",isDeletable:!0,imageUrl:"https://source.unsplash.com/random"})};IsDeletable.parameters={...IsDeletable.parameters,docs:{...IsDeletable.parameters?.docs,source:{originalSource:'{\n  render: () => <WritingVoteOption ariaLabel="" imageUrl="" handleUpdateOptionChange={() => {}} handleDeleteOptionClick={() => {}} handleRemoveImageClick={() => {}} handleUploadImage={() => {}} optionId={Math.floor(Math.random() * 100000)} text="방학 때 강릉으로  강아지와 기차여행을 하려했지\n  만 장마가 와서 취소했어요. 여행을 별로 좋" isDeletable={true} />\n}',...IsDeletable.parameters?.docs?.source}}},IsNotDeletable.parameters={...IsNotDeletable.parameters,docs:{...IsNotDeletable.parameters?.docs,source:{originalSource:'{\n  render: () => <WritingVoteOption ariaLabel="" imageUrl="" handleUpdateOptionChange={() => {}} handleDeleteOptionClick={() => {}} handleRemoveImageClick={() => {}} handleUploadImage={() => {}} optionId={Math.floor(Math.random() * 100000)} text="방학 때 강릉으로  강아지와 기차여행을 하려했지\n  만 장마가 와서 취소했어요. 여행을 별로 좋" isDeletable={false} />\n}',...IsNotDeletable.parameters?.docs?.source}}},ShowImage.parameters={...ShowImage.parameters,docs:{...ShowImage.parameters?.docs,source:{originalSource:'{\n  render: () => <WritingVoteOption ariaLabel="" handleUpdateOptionChange={() => {}} handleDeleteOptionClick={() => {}} handleRemoveImageClick={() => {}} handleUploadImage={() => {}} optionId={Math.floor(Math.random() * 100000)} text="방학 때 강릉으로  강아지와 기차여행을 하려했지\n  만 장마가 와서 취소했어요. 여행을 별로 좋" isDeletable={true} imageUrl="https://source.unsplash.com/random" />\n}',...ShowImage.parameters?.docs?.source}}};const __namedExportsOrder=["IsDeletable","IsNotDeletable","ShowImage"]},"./src/components/optionList/WritingVoteOptionList/WritingVoteOption/OptionCancelButton/index.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Z:()=>OptionCancelButton});__webpack_require__("./node_modules/react/index.js");const x_mark_white_namespaceObject=__webpack_require__.p+"static/media/x_mark_white.5e090f6f.svg";var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),style=__webpack_require__("./src/components/optionList/WritingVoteOptionList/WritingVoteOption/style.ts");const Container=styled_components_browser_esm.zo.button`
  ${style.T$}
...
`},"./src/constants/policyMessage.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{K8:()=>CONTENT_PLACEHOLDER,NF:()=>POST_DEADLINE_POLICY,Nk:()=>POST_TITLE_POLICY,Rp:()=>NICKNAME_POLICY,kL:()=>POST_OPTION_POLICY});const NICKNAME_POLICY={LETTER_AMOUNT:"2자에서 15자 이내로 입력해주세요.",NO_DUPLICATION:"중복된 닉네임은 사용할 수 없습니다.",LIMIT_CHANGING:"닉네임 변경은 1개월간 1번으로 제한됩니다.",LIMIT_LETTER_TYPE:"한글/영어/숫자를 사용해 닉네임을 지어주세요."},POST_TITLE_POLICY={DEFAULT:"제목을 입력해주세요 (100자 이내)",LETTER_AMOUNT:"100자 이내로 입력해주세요."},POST_CONTENT_POLICY={DEFAULT:"내용을 입력해주세요 (1000자 이내)",LETTER_AMOUNT:"1000자 이내로 입력해주세요.",PHOTO_COUNT:"1장의 사진을 업로드 할 수 있습니다.",PHOTO_SHAPE:"사진은 정사각형으로 잘라져 업로드됩니다.",PHOTO_CAPACITY:"용량은 5MB으로 제한됩니다."},POST_OPTION_POLICY={DEFAULT:"선택지를 입력해주세요 (50자 이내)",LETTER_AMOUNT:"50자 이내로 입력해주세요.",AMOUNT:"2개 ~ 5개 선택지를 작성해주세요.",PHOTO_COUNT:"1장의 사진을 업로드 할 수 있습니다.",PHOTO_SHAPE:"사진은 정사각형으로 잘라져 업로드됩니다.",PHOTO_CAPACITY:"용량은 5MB으로 제한됩니다."},POST_DEADLINE_POLICY={DEFAULT:"3일 이내로 마감시간을 정해주세요."},CONTENT_PLACEHOLDER=[POST_CONTENT_POLICY.DEFAULT,POST_CONTENT_POLICY.PHOTO_COUNT,POST_CONTENT_POLICY.PHOTO_CAPACITY,POST_CONTENT_POLICY.PHOTO_SHAPE].join("\n - ")},"./src/styles/theme.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{r:()=>theme});var styled_components__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const theme={breakpoint:{sm:"576px",md:"768px",lg:"1440px"},zIndex:{select:1,header:100,modal:200},animation:{skeletonGradientPulse:styled_components__WEBPACK_IMPORTED_MODULE_0__.F4`
  0% {
...
//# sourceMappingURL=components-optionList-WritingVoteOptionList-WritingVoteOption-WritingVoteOption-stories.1f4ba565.iframe.bundle.js.map